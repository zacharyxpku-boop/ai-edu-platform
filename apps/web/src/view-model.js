export const WEB_DEMO_STATE = {
  ...
  uploads: [
    { file: '四年级数学单元卷.jpg', type: '错题照片', size: '2.4MB', status: '分析完成', color: 'orange' },
    { file: '期末成绩单.pdf', type: '成绩单', size: '1.2MB', status: '分析完成', color: 'blue' },
    { file: '学习风格测评.pdf', type: '天赋测评', size: '0.9MB', status: '分析完成', color: 'green' },
    { file: '家长观察记录.docx', type: '家长观察', size: '0.6MB', status: '待补充', color: 'yellow' }
  ]
};
...
export const WEB_PAGE_GUIDES = {
  ...
  report: {
    ...
    steps: [
      ...
      ['02', '匹配方法', '把学习信号映射到费曼、苏格拉底、回忆复习和变式训练。'],
      ['03', '去执行', '进入 AI私教第一问或复习验证。']
    ],
    cta: ['tutor', '进入 AI私教']
  },
  tutor: {
...
export const WEB_MATERIAL_PIPELINE = [
  ['材料入口', '天赋测评、成绩单、错题、学校反馈和家长观察先归档。'],
  ['证据分级', '强证据、弱证据、方法假设分开标注，避免给孩子贴标签。'],
  ['行动出口', '报告、AI私教、复习和家长问题共用同一组证据。']
];
