...
assert(profilePageWxml.includes('parent-dash-evidence') && profilePageWxml.includes('parent-report-preview') && profilePageWxml.includes('parent-dash-action-row'), 'profile report renders the new parent evidence preview and next-action copy');
