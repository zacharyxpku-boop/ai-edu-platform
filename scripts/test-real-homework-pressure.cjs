...
assert(profilePageWxml.includes('本地/AI路线') && profilePageWxml.includes('来源落地') && profilePageWxml.includes('停止规则'), 'profile report renders local/AI runway, source landing, and stop-rule copy');
