...
assert(gameLogicJs.includes('buildPublicK12IntakeExecutableCards') && storageJs.includes('publicK12IntakeChallengeDeck') && tutorPageJs.includes('publicK12IntakeChallenge'), 'review/tutor loop consumes public K12 intake challenge deck as executable cards without reopening legacy arcade UI');
