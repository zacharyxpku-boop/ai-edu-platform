...
assert(['yd-parent-sources', 'yd-parent-decision', 'yd-parent-action-row'].every((token) => profileWxml.includes(token)), 'profile summary renders the new parent evidence and next-action sections');
