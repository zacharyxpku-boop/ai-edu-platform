...
assert(read('miniprogram/pages/profile/profile.js').includes('crossWeekTrendBoard') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.crossWeekTrendRows'), 'Profile exposes cross-week trend board');
assert(read('miniprogram/pages/profile/profile.js').includes('homeSchoolCollaborationDigest') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.homeSchoolEvidencePacket'), 'Profile exposes home-school collaboration digest');
assert(read('miniprogram/pages/profile/profile.js').includes('homeSchoolConferenceKit') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.homeSchoolConferenceTeacherQuestions'), 'Profile exposes home-school conference kit');
assert(read('miniprogram/pages/profile/profile.js').includes('familyDecisionIntakeSourcePlan') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.familyDecisionIntakeSourcePlan'), 'Profile exposes family decision input lanes');
assert(read('miniprogram/pages/profile/profile.wxml').includes('familyDecisionAiLocalWorkSplit'), 'Profile exposes AI/local decision split');
assert(read('miniprogram/pages/profile/profile.js').includes('sourceEvidenceLedger') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.sourceEvidenceLanes'), 'Profile exposes the source evidence ledger');
assert(read('miniprogram/pages/profile/profile.js').includes('uploadedMaterialDecisionDossier') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.uploadedMaterialDecisionDossierMaterialLanes'), 'Profile exposes uploaded-material decision dossier');
...
assert(read('miniprogram/pages/profile/profile.js').includes('servicePathwayValidationPlan') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.servicePathwayValidationPlan'), 'Profile exposes uploaded-material service pathway validation plan');
assert(read('miniprogram/pages/profile/profile.js').includes('uploadedMaterialDecisionDossierMethodCandidateCards') && read('miniprogram/pages/profile/profile.wxml').includes('uploadedMaterialDecisionDossierMethodCandidateCards'), 'Profile exposes explicit method candidate cards');
assert(read('miniprogram/pages/profile/profile.js').includes('uploadedMaterialDecisionDossierMethodologyGuide') && read('miniprogram/pages/profile/profile.wxml').includes('uploadedMaterialDecisionDossierMethodologyCards'), 'Profile exposes evidence-based methodology guide');
assert(read('miniprogram/pages/profile/profile.js').includes('uploadedMaterialDecisionDossierFamilyDecisionCalendar') && read('miniprogram/pages/profile/profile.wxml').includes('决策日历'), 'Profile exposes the uploaded-material family decision calendar');
assert(read('miniprogram/pages/profile/profile.js').includes('uploadedMaterialDecisionDossierDetailedSections') && read('miniprogram/pages/profile/profile.wxml').includes('详细报告章节'), 'Profile exposes detailed uploaded-material report sections');
assert(read('miniprogram/pages/profile/profile.js').includes('uploadedMaterialDecisionDossierSolutionBlueprint') && read('miniprogram/pages/profile/profile.wxml').includes('个性化学习方案蓝图'), 'Profile exposes the personalized learning solution blueprint');
assert(read('miniprogram/pages/profile/profile.js').includes('uploadedMaterialDecisionDossierPrivateTutorSolutionPack') && read('miniprogram/pages/profile/profile.wxml').includes('家庭私教方案'), 'Profile exposes the family private tutor solution pack');
assert(read('miniprogram/pages/profile/profile.js').includes('uploadedMaterialDecisionDossierWrongPaperDiagnosisCards') && read('miniprogram/pages/profile/profile.wxml').includes('错题诊断'), 'Profile exposes wrong-paper diagnosis cards');
assert(read('miniprogram/pages/profile/profile.js').includes('gameReturnEvidence') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.gameReturnEvidenceNextDayCardIds'), 'Profile exposes game return evidence from arcade/review loops');
assert(read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.gameReturnEvidenceBlockedFields') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.gameReturnEvidenceLocalCodeOwns'), 'Profile renders game return safety fields and local-code ownership');
assert(read('miniprogram/pages/profile/profile.js').includes('aiLocalImplementationMatrix') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.aiLocalImplementationRows'), 'Profile exposes the AI/local implementation matrix');
assert(read('miniprogram/pages/profile/profile.wxml').includes('能力分工') && read('miniprogram/pages/profile/profile.wxml').includes('下一加厚'), 'Profile renders AI/local capability split and next thickening order');
assert(read('miniprogram/pages/profile/profile.js').includes('buildFamilyDecisionHomepage') && read('miniprogram/pages/profile/profile.js').includes('familyDecisionHomepageLocalAiSplitLine'), 'Profile builds a parent-first family decision homepage');
assert(read('miniprogram/pages/profile/profile.js').includes('buildTonightParentDecisionCard') && read('miniprogram/pages/profile/profile.js').includes('tonight_parent_decision_card'), 'Profile compresses the family decision homepage into a four-line tonight parent card');
assert(read('miniprogram/pages/profile/profile.wxml').includes('tonight-parent-decision-card') && read('miniprogram/pages/profile/profile.wxml').includes('tonightParentDecisionCardRows'), 'Profile renders the four-line tonight parent card before detailed report ledgers');
assert(read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.familyDecisionHomepageHeadline') && read('miniprogram/pages/profile/profile.wxml').includes('learningReportSummary.familyDecisionHomepageBlockedFields'), 'Profile renders the family decision homepage before detailed ledgers');
