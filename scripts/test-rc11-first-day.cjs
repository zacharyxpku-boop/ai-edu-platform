...
assert(files.reviewWxml.includes('review-hero-shell'), 'review uses the new challenge shell');
...
assert(files.tutorWxml.includes('tutor-hero-shell') && files.tutorWxml.includes('tutor-entry-grid'), 'tutor uses the compact first-step shell');
assert(files.arcadeWxml.includes('arcade-hero-shell') && files.arcadeWxml.includes('ux-kit-jump-grid'), 'arcade uses the compact review island shell');
...
assert(files.profileWxml.includes('parent-hero-shell'), 'profile uses the new parent shell');
assert(files.profileWxml.includes('parent-dash-route') && files.profileVm.includes('oneNightProof'), 'profile keeps the family next-step proof line');
