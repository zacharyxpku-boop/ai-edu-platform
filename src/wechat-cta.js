...
(function () {
    ...
    var CHANNEL_LABEL = {
        ...
        'pricing-online': '家庭学习决策系统体验咨询',
        'pricing-camp': '作业三分类与家长复盘咨询',
        'pricing-flagship': '一周家庭学习决策陪跑咨询',
        'report-cta': '基于诊断报告做一次家庭复盘',
        'platform-engine': '原点自研技术深度沟通',
        'membership-basic': '家庭决策台体验名额',
        'membership-family': '家庭学习复盘咨询',
